 ...
 * @UniqueEntity(
 *  fields={"email"},
 * message="Un autre utilisateur s'est déjà inscrit avec cette adresse email, merci de le modifier"
 * )
 */
class User implements UserInterface
{
    ...
    /**
     * 
     *@Assert\EqualTo(propertyPath="hash",message="Vous n'avez pas correctemment confirmé votre mot de passe")
     * 
     */
